#!/usr/bin/python3
"""This is to defines unittests for models/state.py.
...
class TestState_instantiation(unittest.TestCase):
    """This is a Unittests for testing instantiation of the State class."""
...
class TestState_save(unittest.TestCase):
    """This is a Unittests for testing save method of the State class."""
...
class TestState_to_dict(unittest.TestCase):
    """This is a Unittests for testing to_dict method of the State class."""
