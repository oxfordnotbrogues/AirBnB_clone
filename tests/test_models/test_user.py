#!/usr/bin/python3
"""This is to defines unittests for models/user.py.
...
class TestUser_instantiation(unittest.TestCase):
    """This is a Unittests for testing instantiation of the User class."""
...
class TestUser_save(unittest.TestCase):
    """This is a Unittests for testing save method of the  class."""
...
class TestUser_to_dict(unittest.TestCase):
    """This is a Unittests for testing to_dict method of the User class."""
