#!/usr/bin/python3
"""THis is to defines unittests for models/place.py.
...
class TestPlace_save(unittest.TestCase):
    """This is a Unittests for testing save method of the Place class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """This is a Unittests for testing to_dict method of the Place class."""
